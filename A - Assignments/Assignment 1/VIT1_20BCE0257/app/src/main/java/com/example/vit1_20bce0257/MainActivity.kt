package com.example.vit1_20bce0257
...
import com.example.vit1_20bce0257.ui.theme.VIT1_20BCE0257Theme
    ...
    )
    {
        ...
        , colors = CardDefaults.cardColors(containerColor = White)
            ...
            horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Image(painter = painterResource(id = R.drawable.insta), contentDescription = "",
                ...
                Row() {
                    Button(onClick = { }, colors = ButtonDefaults.buttonColors(Color(0xff3a97f0)),
                        modifier = Modifier.padding(20.dp)) {
                            Image(painter = painterResource(id = R.drawable.fb), contentDescription = "",
